			...
			<div className="dlab-demo-inner">
				...
				<PerfectScrollbar  className="dlab-demo-content ps ps--active-y">	
					<div className="dlab-wrapper ">
						<div className="overlay-bx rounded-lg dlab-demo-bx demo-active">
						...
						<hr />
						<div className="overlay-bx rounded-lg dlab-demo-bx ">
						...
						<div className="overlay-bx rounded-lg dlab-demo-bx ">
							...
							<div className="overlay-layer">
								<Link to={"#"} onClick={() => setDemoTheme(7,'ltr')} data-theme="7" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
							</div>
						</div>
						...
						<div className="overlay-bx rounded-lg dlab-demo-bx ">
							...
							<div className="overlay-layer">
								<Link to={"#"} onClick={() => setDemoTheme(8,'ltr')} data-theme="8" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
							</div>
						</div>
